# Garcar Autonomous Wiring TODO for autonomous-orchestrator-core
...
- [x] `/health` — present (aligned to status/system/version/timestamp)
- [x] `/meta` — **added** (role master_orchestrator, contract_version 1.0.0)
- [x] `/metrics` — **added** (JSON counters)
- [x] `/events` — **added** (in-memory ring)

## Event Bus Wiring
- [ ] Emit required events for this role (`garcar.autonomous-orchestrator-core.{event_type}`).
